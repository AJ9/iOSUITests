...
class iOSUITestsUITests: XCTestCase {
    ...
    func test_checkLoginScreen_hasCorrectTitle() {
        XCTAssert(app.staticTexts[""].exists)
    }

    func test_checkLoginScreen_hasCorrectDate() {
        XCTAssert(app.staticTexts[""].exists)
    }

    func test_checkLoginScreen_hasEmailTextfield() {
        XCTAssert(app.textFields["EmailField"].exists)
    }

    func test_checkLoginScreen_hasPasswordTextfield() {
        XCTAssert(app.textFields["PasswordField"].exists)
    }

    func test_checkLoginScreen_hasSignInButton() {
